  ...
  return (
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className='bg-no-repeat bg-cover'>
      ...
      <section className='h-16 bg-white flex items-center px-4'>
            ...
            openImageVideoUpload && (
              <div className='bg-white shadow rounded absolute bottom-14 w-36 p-2'>
                <form>
                  ...
                  <input type='file' onChange={handleUploadImage} id='uploadImage' className='hidden' />
                  <input type='file' onChange={handleUploadVideo} id='uploadVideo' className='hidden' />
                </form>
              </div>
            )
          }        
        ...
        <form onSubmit={handleSendMessage} className='flex h-full w-full gap-2'>
